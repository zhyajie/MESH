#!/usr/bin/env bash
# =============================================================================
# Script 2: Start Decode Server (kv_consumer) - Multi-Node 1P1D
# Run this INSIDE the docker container on the decode node (e.g., g52).
...
DECODE_RDMA_IP="${DECODE_RDMA_IP:-10.103.52.101}"
...
echo ""
echo "============================================================"
echo "  Decode Server (kv_consumer) - Multi-Node 1P1D"
echo "============================================================"
echo " Model:       ${MODEL}"
...
echo " RDMA IP:     ${DECODE_RDMA_IP}"
echo " Protocol:    ${MOONCAKE_PROTOCOL}"
echo "============================================================"

export HIP_VISIBLE_DEVICES="${GPU_IDS}"
export VLLM_HOST_IP="${DECODE_RDMA_IP}"
