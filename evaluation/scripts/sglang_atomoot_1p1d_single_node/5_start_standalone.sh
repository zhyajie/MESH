#!/usr/bin/env bash
# =============================================================================
# Script 5: Standalone SGLang Server (no PD disaggregation)
# Run this INSIDE the docker container (rocm/atom-mesh).
# Model: Qwen3-8B-FP8-dynamic, TP=1, single GPU
# =============================================================================
set -euo pipefail
...
echo ""
echo "============================================================"
echo "  Standalone SGLang Server - $(hostname)"
echo "============================================================"
echo " Model:              ${MODEL}"
...
echo "[launch] Starting SGLang server..."
